...
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ 
#define AXIS1_STEPS_PER_DEGREE     7111.111 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
                                          // Juwei-17 used 7182.2222 but I think that was wrong, 7111.111 is what I calculated based on the gear ratio and stepper motor specs.
#define AXIS1_REVERSE                 ON  //    geeksville: reversed on Juwei! was OFF, ON Reverses movement direction, or reverse wiring instead to correct.   <-Often
...
// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS2_STEPS_PER_DEGREE  7111.111 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
                                          // Juwei-17 used 7182.2222 but I think that was wrong, 7111.111 is what I calculated based on the gear ratio and stepper motor specs.
...
#define PARK_STATUS_PIN               2   // geeksville: use the "heater" output to control the Park lock solinoid on the Juwei
...
#define SLEW_RATE_BASE_DESIRED        2.6 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
                                          //         1/2 to 2x this rate, and as performace considerations require.
                                          // geeksville - supposedly 5.0 works with bigger motors
...
#define FOCUSER_TEMPERATURE    OFF //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n for focuser temp. (TE)       Adjust
...
#define FEATURE1_PIN                  OFF //    OFF, AUX for auxiliary pin, n. Where n is the pin#. (E0)                      Adjust
                                          // geeksville was 1
